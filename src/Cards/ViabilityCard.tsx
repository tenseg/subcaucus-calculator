	...
	render() {
		...
		return (
			...
			>
				...
				<p><strong>Step No. 1:</strong> Add up the total number of members of all the subcaucuses. [{s.room}]</p>

				<p><strong>Step No. 2:</strong> Divide the result of Step No. 1 by the total number of delegates to be elected [<strong>{s.viability.decimalPlaces(3)}</strong>]. If there is a remainder, round the result up to the next whole number. This is the viability number [<strong>{s.wholeViability}</strong>].</p>
				...
				<p><strong>First:</strong> Add up the total number of members of all the viable subcaucuses [<strong>{s.viableRoom}</strong>].</p>

				<p><strong>Second:</strong> Divide the result of the first step by the total number of delegates to be elected. Carry this division out to at least three decimal places [<strong>{s.delegateViability.decimalPlaces(3)}</strong>].</p>
